    ...
    <div class="row about-container">
      <div class="col-lg-6 content order-lg-1 order-2">
        ...
        <div class="icon-box wow fadeInUp" data-wow-delay="0.4s">
          ...
          <h4 class="title">
            <a href>Administracion de CSM</a>
          </h4>
          <p
            class="description"
      ...
      <div class="col-lg-6 background order-lg-2 order-1 wow fadeInUp">
        <img src="img/rompecabezas.svg" class="img-fluid" alt width="75%" height="75%" />
      </div>
    </div>
    <div class="row about-extra">
      <div class="col-lg-6 wow fadeInUp">
        <img src="img/analisis.svg" class="img-fluid" alt width="75%" height="75%" />
      </div>
      <div class="col-lg-6 wow fadeInUp pt-5 pt-lg-0">
        <h4>Un proceso de diseño impulsado por análisis</h4>
        <p>Estudio de rutas de conversión, los factores de búsqueda, los mensajes adecuados en el lugar indicado y los datos de rendimiento para tomar mejores decisiones de diseño.</p>
        <p>Asi nuestros clientes obtienen una herramienta de ventas que trabaja todos los dias del años las 24 horas.</p>
      </div>
    </div>
    <div class="row about-extra">
      ...
      <div class="col-lg-6 wow fadeInUp pt-4 pt-lg-0 order-2 order-lg-1">
        <h4>El diseño debe tener un proposito</h4>
        <p>incorporo diseño, tecnología, contenido y marketing. Estoy enfocado en ayudar a las organizaciones a alcanzar objetivos centrales de negocios usando el espacio digital.</p>
        <p>Diseño y construción de sitios web para impactar las ventas, la promoción y la generación de clientes potenciales.</p>
      </div>
    </div>
  </div>
</template>
